...
public class ElixirStorageBuilding extends Building {
    ...
    public ElixirStorageBuilding(int id_, int userId_, int x_,int y_, int level_, int buildingStatus_, int finishTime_) {
        super(id_, userId_, x_, y_, Building.ELIXIR_STORAGE, level_, buildingStatus_, finishTime_);
        loadConfig();
